<?php
	...
	if($vw_automobile_lite_first_color != false){
		$vw_automobile_lite_custom_css .='a, span.email i, span.timings i, span.call i, .sidebar .widget h3, .post-main-box h2, .blogbutton-small, h2.single-post-title, .sidebar .custom-social-icons i:hover, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title, .entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, .main-navigation a:hover, .main-navigation ul.sub-menu a:hover, .footer a.custom_read_more, .sidebar a.custom_read_more, h1.single-post-title, .footer li a:hover, .sidebar ul li a:hover, span.email a:hover, span.call a:hover, .slider .inner_carousel h1 a:hover, .choose_us h3 a:hover{';
