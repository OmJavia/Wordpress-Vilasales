    ...
    <div class="tab-sec">
		...
		<div id="product_addons_editor" class="tabcontent product_woo_tab">
			<?php if(!is_plugin_active('ibtana-ecommerce-product-addons/plugin.php')){ 
				...
				<div class="vw-automobile-lite-recommended-plugins">
			    	<div class="vw-automobile-lite-action-list">
                	<div class="vw-automobile-lite-action" id="<?php echo esc_attr($vw_automobile_lite_actions['id']);?>">
                     <div class="action-inner plugin-activation-redirect">
                        <h3 class="action-title"><?php echo esc_html($vw_automobile_lite_actions['title']); ?></h3>
                        <div class="action-desc"><?php echo esc_html($vw_automobile_lite_actions['desc']); ?>
                        </div>
                        <?php echo wp_kses_post($vw_automobile_lite_actions['link']); ?>
                     </div>
                	</div>
			    	</div>
				</div>
			<?php }else{ ?>
				...
				<hr class="h3hr">
	              	<div class="vw-automobile-lite-pattern-page">
		    			<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-automobile-lite'); ?></a>
		    		</div>
			<?php } ?>
		</div>
